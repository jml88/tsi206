...
public class JugadorControlador implements IJugadorControlador {
	...
	public Set<Jugador> generarJugadores(int cant, Equipo equipo){
		...
		try {
			nombres = Files.readAllLines(FileSystems.getDefault().getPath("/home/matias/git/tsi206/jatrick/logica_jatrik/ejbModule/META-INF/archivos/", "nombres"));
			apellidos = Files.readAllLines(FileSystems.getDefault().getPath("/home/matias/git/tsi206/jatrick/logica_jatrik/ejbModule/META-INF/archivos/", "apellidos"));
		} catch (IOException e) {
